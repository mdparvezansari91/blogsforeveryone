...
const publicPaths = ['/', '/signin', '/signup', '/api/signin', '/api/signup', '/api/articles', '/articles', '/api/blogs', '/blogs','/privacy', '/ads.txt','/uploadposts','api/uploadposts', '/posts','api/posts'];
